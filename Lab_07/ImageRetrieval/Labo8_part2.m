...
%% Dictionary
numClusters_all = [30, 100, 200, 300, 500, 1000]; 
...
my_query_image='../ImageRetrieval/images/122600.jpg';%'../ImageRetrieval/images/103100.jpg'; 
imgpath=my_query_image;

I = imread(imgpath);
I = single(rgb2gray(I));
imlist1 = imlist;
imlist1{length(imlist)+1} = my_query_image;
